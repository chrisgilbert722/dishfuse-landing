...
/**
 * DishFuse — Landing (CLS-Fixed + Footer Logo Fixed)
 * - Chat demo has locked height (B ≈ 420px) so no layout shift
 * - Footer logo sized by height only (no distortion), responsive
 * - Trust logos: fixed width/height to avoid CLS
 * - KPI tiles + right-side cards: min-heights for stability
 * - Hero/Chat videos: poster first, then swap in after first paint
 */
...
export default function LandingPage() {
  ...
  // Smart video swap (poster first → video after first paint/idle)
    ...
    <main className="min-h-screen text-white bg-gradient-to-b from-[#1F2D50] to-[#24335D]">
      <style jsx global>{`
        ...
        * {
        ...
        /* Footer logo: height-only sizing (no distortion) */
        .footer-logo {
          height: 32px;
          width: auto;
        }
        ...
        /* Chat demo locking — Option B ≈ 420px */
        .chatStage {
          min-height: 420px;
        }
        .chatBubble {
        ...
        /* KPI / Right cards min-heights for stability */
        .kpiCard {
          min-height: 100px;
        }
        .rightCard {
      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[rgba(11,18,34,0.7)] backdrop-blur-md">
        <div className="max-w-[1200px] mx-auto flex justify-between items-center py-3 px-4">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <a href="#cta" className="btn btn-primary gold-glow" aria-label="Start Free Trial">
              Start Free Trial
            </a>
          </div>
        </div>
      ...
      <section className="relative min-h-[84vh] flex items-center overflow-hidden">
        ...
        <div className="container relative z-10 grid md:grid-cols-2 gap-10 items-center py-16">
          <div>
            ...
            {/* TRUST BADGES (fixed sizes → no CLS) */}
          ...
          <div className="glass rounded-2xl p-5 md:p-6" style={{ minHeight: 220 }}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                <div key={x.d} className="card text-center kpiCard">
      ...
      <section id="demo" className="relative section overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            {/* LEFT: Chat bubbles in locked stage (no page push) */}
            <div className="glass rounded-2xl p-6 chatStage">
              ...
              <div className="space-y-4">
                ...
                {chatStep >= 2 && (
                  <div className="chatBubble user">Great — how much mozzarella should I order?</div>
                )}
                {chatStep >= 3 && (
                  <div className="chatBubble ai">
            ...
            <div className="grid gap-4">
              {[
                ...
                <div key={h} className="card rightCard">
      ...
      {/* PROFIT CALCULATOR (unchanged from your last working build) */}
      <ROIProfitCalculator />
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={t.plan} className={`card ${t.popular ? "priceCard popular" : "priceCard"}`}>
                {t.popular && (
                  <div
...
/* ---------- Profit Calculator (unchanged logic) ---------- */
function ROIProfitCalculator() {
  ...
  const LIFT_MIN = 0.12;
  const LIFT_MAX = 0.24;
  const LIFT_MID = (LIFT_MIN + LIFT_MAX) / 2;
  ...
  const meterPct = Math.round(LIFT_MID * 100);
